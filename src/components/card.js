    ...
    return (
        <>
            <div className="card mx-5">
                ...
                <p className="pt-1"><i className="fa-solid fa-star"></i>({props.card.stats.rating})<p className="review-grey d-inline ps-1">{props.card.stats.reviewCount} - {props.card.location}</p></p>
